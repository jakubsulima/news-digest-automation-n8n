import { findInterestFallbackCandidateId, hardEligibilityReasons } from "./eligibility";
...
export const DIGEST_BASELINE_POLICY_VERSION = "digest-selection-v1.1";
export const DIGEST_RECOMMENDATION_POLICY_VERSION = "recommendation-policy-v2.1";
